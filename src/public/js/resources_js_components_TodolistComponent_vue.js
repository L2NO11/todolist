  ...
  setup: function setup(props, _ref) {
    ...
    (0,vue__WEBPACK_IMPORTED_MODULE_0__.onMounted)(function () {
      var _route$query = route.query,
          ...
          _route$query$job = _route$query.job,
          job = _route$query$job === void 0 ? "" : _route$query$job;
...
/* harmony import */ var _FilterComponent_vue__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./FilterComponent.vue */ "./resources/js/components/FilterComponent.vue");
/* harmony import */ var _ListComponent_vue__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./ListComponent.vue */ "./resources/js/components/ListComponent.vue");
/* harmony import */ var _PaginationComponent_vue__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./PaginationComponent.vue */ "./resources/js/components/PaginationComponent.vue");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  components: {
    filterComponent: _FilterComponent_vue__WEBPACK_IMPORTED_MODULE_2__["default"],
    ListComponent: _ListComponent_vue__WEBPACK_IMPORTED_MODULE_3__["default"],
    PaginationComponent: _PaginationComponent_vue__WEBPACK_IMPORTED_MODULE_4__["default"]
  },
  setup: function setup() {
    ...
    var refreshWithName = /*#__PURE__*/function () {
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                ...
                _context3.next = 5;
                return store.dispatch("getTodolistWithName", params).then(function (resp) {
                  console.log("resp", resp);
      ...
      return function refreshWithName() {
        return _ref3.apply(this, arguments);
      };
    }();

    var superRefresh = function superRefresh() {
      if ((!route.query.isAll || route.query.isAll === "true") && !route.query.job) {
        refreshPage();
    ...
    (0,vue__WEBPACK_IMPORTED_MODULE_0__.watch)(route, /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5() {
        ...
        return _regeneratorRuntime().wrap(function _callee6$(_context6) {
          while (1) {
            switch (_context6.prev = _context6.next) {
              case 0:
                _context6.next = 2;
                return (0,_mixin__WEBPACK_IMPORTED_MODULE_1__.Todo)("done", id, "Done complete at id :" + id, "Done fail");
        ...
        return _regeneratorRuntime().wrap(function _callee7$(_context7) {
          while (1) {
            switch (_context7.prev = _context7.next) {
              case 0:
                _context7.next = 2;
                return (0,_mixin__WEBPACK_IMPORTED_MODULE_1__.Todo)("deleteTodo", id, "Delete complete at id :" + id, "Delete fail");
...
var _hoisted_7 = {
  "class": "input-group justify-content-center w-75"
};
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  ), [[vue__WEBPACK_IMPORTED_MODULE_0__.vModelSelect, $setup.filterCompleted]])]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_7, [_hoisted_8, (0,vue__WEBPACK_IMPORTED_MODULE_0__.withDirectives)((0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("input", {
    type: "text",
  ...
  /* NEED_PATCH */
  ), [[vue__WEBPACK_IMPORTED_MODULE_0__.vModelText, $setup.taskName]]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("button", {
    onClick: _cache[3] || (_cache[3] = function () {
      return $setup.find && $setup.find.apply($setup, arguments);
    }),
    type: "submit",
    "class": "btn btn-primary"
  }, " Search ")]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_9, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_10, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.withDirectives)((0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("input", {
  ...
  /* NEED_PATCH */
  ), [[vue__WEBPACK_IMPORTED_MODULE_0__.vModelCheckbox, $setup.dateIsCheck]]), _hoisted_11]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_12, [!$setup.dateIsCheck ? (0,vue__WEBPACK_IMPORTED_MODULE_0__.withDirectives)(((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("input", {
    key: 0,
    type: "date",
...
function Todo(_x, _x2, _x3, _x4) {
  return _Todo.apply(this, arguments);
}

function _Todo() {
  _Todo = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(dispatchName, id, textSucess, textFailed) {
    var store;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            store = (0,vuex__WEBPACK_IMPORTED_MODULE_0__.useStore)();
            _context.next = 3;
